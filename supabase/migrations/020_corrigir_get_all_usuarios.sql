-- ============================================================
-- 020: Corrigir get_all_usuarios (faltavam plano, status e ultimo login)
-- ============================================================
...
BEGIN
    ...
    LEFT JOIN LATERAL (
        SELECT status, fim_periodo, trial_termina, plano_id
        FROM assinaturas
...
-- Admin pode ver assinaturas de outros usuarios
CREATE POLICY "Admin ve qualquer assinatura" ON assinaturas
  FOR SELECT USING (
